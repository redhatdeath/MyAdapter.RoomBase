...
import ru.shanin.myadapter.fragments.about_people.AboutPeople;
import ru.shanin.myadapter.generate.NewData;
...
public class ListOfPeople extends Fragment {
    ...
    private void startAboutPeople(People people) {
        Fragment fragment = AboutPeople.newInstance(
                (new Gson()).toJson(people), people.get_id());
