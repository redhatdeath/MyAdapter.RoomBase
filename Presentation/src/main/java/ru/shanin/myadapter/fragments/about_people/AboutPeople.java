...
public class AboutPeople extends Fragment {
    ...
    public static AboutPeople newInstance(
        ...
        args.putString(ARGUMENT_PEOPLE_ID, people_Id);
    ...
    private void parseParams() {
        ...
        people_Id = args.getString(ARGUMENT_PEOPLE_ID);
    }
    ...
    private void initViewModel() {
        ...
        viewModel.getPeople(people_Id).observe(
    ...
    private void initView(View view) {
        ...
        ((TextView) view.findViewById(R.id.tv_fn))
                .setText(people.getPeopleInfo().getLastName());
        String fnsn = people.getPeopleInfo().getFirstName() + " " + people.getPeopleInfo().getSecondName();
